...
after your program is run it will print 2 
...
=end
arr = [1, 5, 10, -2]
puts arr.map! { |elem| elem * elem } #danger bang exclamation
...
Given any array x, say [1, 5, 10, -2], 
create an algorithm that returns a hash with the maximum number in the array, 
...
=begin
Number to String
13) Write a program that takes an array of numbers 
